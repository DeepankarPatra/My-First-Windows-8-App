...
namespace SmartToDoCS
{
    ...
    /// </summary>
    public sealed partial class ThirdPage : SmartToDoCS.Common.LayoutAwarePage
    {
        public ThirdPage()
        {
            this.InitializeComponent();
            this.Loaded += new RoutedEventHandler(ThirdPage_Loaded);
        }
        private void ThirdPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            TaskList.ItemsSource = db.Table<TaskTable>();
            db.Close();
        }
        /// <summary>
